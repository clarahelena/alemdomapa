...
* Um arquivo chamado `usuarios.json` e `estabelecimentos.json` na mesma pasta do script.
...
* 📍 **Recomendações Locais:** Receba sugestões de estabelecimentos bem avaliados por moradores locais.
...
* 📜  **Lista "Quero Conhecer":** Adicione estabelecimentos à sua lista de favoritos para visitar depois e gerencie-os (visualizar detalhes, avaliar ou remover).
